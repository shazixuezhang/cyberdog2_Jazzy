...
#include "cyberdog_protocol/lcm/danger_states_lcmt.hpp"
...
private:
  ...
  void HandleMotorTempCallback(
    const cyberdog_protocol::srv::MotorTemp_Request::SharedPtr req,
    cyberdog_protocol::srv::MotorTemp_Response::SharedPtr res);
  rclcpp::Node::SharedPtr node_;
  rclcpp::Service<cyberdog_protocol::srv::MotorTemp>::SharedPtr motor_temp_srv_ {nullptr};
