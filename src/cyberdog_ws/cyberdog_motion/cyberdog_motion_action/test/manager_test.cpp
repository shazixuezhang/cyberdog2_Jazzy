...
public:
  SimMotionManager(const std::string & name)
  {
    ...
    msg_t_.reset(new cyberdog_protocol::msg::MotionServoCmd);
    res_t_.reset(new cyberdog_protocol::msg::MotionStatus);
    res_t_->motor_error.resize(12);
    last_msg_.reset(new cyberdog_protocol::msg::MotionServoCmd);
    srv_req_.reset(new cyberdog_protocol::srv::MotionResultCmd::Request);
    ...
    ma_->RegisterFeedback(
      std::bind(
        ...
        std::placeholders::_1));
    motion_cmd_sub_ = node_ptr_->create_subscription<cyberdog_protocol::msg::MotionServoCmd>(
    ...
    motion_result_srv_ =
      node_ptr_->create_service<cyberdog_protocol::srv::MotionResultCmd>(
  ...
  void HandleTestResultCmd(const cyberdog_protocol::srv::MotionResultCmd_Request::SharedPtr req,
                          const cyberdog_protocol::srv::MotionResultCmd_Response::SharedPtr)
  {
    // if(*last_msg_ == *msg)
      // return;
  ...
  void HandleTestServoCmd(const cyberdog_protocol::msg::MotionServoCmd::SharedPtr msg)
  {
    // if(*last_msg_ == *msg)
      // return;
    last_msg_ = msg;
  ...
  void Run()
  {
    cyberdog_protocol::msg::MotionServoCmd::SharedPtr msg(new cyberdog_protocol::msg::MotionServoCmd);
...
private:
  bool CompareMotionServoResponse(cyberdog_protocol::msg::MotionStatus::SharedPtr res1, cyberdog_protocol::msg::MotionStatus::SharedPtr res2)
  {
    bool flag = true;
  ...
  void FeedbackCallback(cyberdog_protocol::msg::MotionStatus::SharedPtr msg)
  {
  ...
  rclcpp::Subscription<cyberdog_protocol::msg::MotionServoCmd>::SharedPtr motion_cmd_sub_{nullptr};
  rclcpp::Service<cyberdog_protocol::srv::MotionResultCmd>::SharedPtr motion_result_srv_{nullptr};
  rclcpp::Subscription<std_msgs::msg::Int16>::SharedPtr motion_result_queue_sub_{nullptr}; 
  cyberdog_protocol::msg::MotionServoCmd::SharedPtr msg_t_{nullptr}, last_msg_{nullptr};
  cyberdog_protocol::srv::MotionResultCmd::Request::SharedPtr srv_req_{nullptr};
  cyberdog_protocol::srv::MotionResultCmd::Response::SharedPtr srv_res_{nullptr};
  cyberdog_protocol::msg::MotionStatus::SharedPtr res_t_;
