...
public:
  SimMotionClient(const std::string & name)
  {
    ...
    motion_result_client_ = node_ptr_->create_client<cyberdog_protocol::srv::MotionResultCmd>(cyberdog::motion::kMotionResultServiceName);
    motion_queue_client_ = node_ptr_->create_client<cyberdog_protocol::srv::MotionSequence>(cyberdog::motion::kMotionSequenceServiceName);
...
private:
  void HandleResultCmd(int argc, char **argv) {
    cyberdog_protocol::srv::MotionResultCmd::Request::SharedPtr req(new cyberdog_protocol::srv::MotionResultCmd::Request);
    toml::value value;
    ...
    // HandleTestCmd(msg);
    // std::shared_future<cyberdog_protocol::srv::MotionResultCmd::Response::SharedPtr> future_result = motion_result_client_->async_send_request(req);
  ...
  void HandleSequenceCmd(int argc, char **argv){
    (void)argc;
    (void)argv;
    cyberdog_protocol::srv::MotionSequence::Request::SharedPtr req(new cyberdog_protocol::srv::MotionSequence::Request);
    req->motion_id = cyberdog_protocol::msg::MotionID::SEQUENCE_CUSTOM;
    ...
    cyberdog_protocol::msg::MotionSequenceParam msg;
    // cyberdog_protocol::msg::MotionCustomCmd msg;
    toml::value steps;
  ...
  rclcpp::Client<cyberdog_protocol::srv::MotionResultCmd>::SharedPtr motion_result_client_{nullptr};
  rclcpp::Client<cyberdog_protocol::srv::MotionSequence>::SharedPtr motion_queue_client_{nullptr};
