...
public:
  SimMotionPublisher(const std::string & name)
  {
    ...
    motion_cmd_pub_ = node_ptr_->create_publisher<cyberdog_protocol::msg::MotionServoCmd>(cyberdog::motion::kMotionServoCommandTopicName, rclcpp::SystemDefaultsQoS());
...
private:
  ...
  rclcpp::Publisher<cyberdog_protocol::msg::MotionServoCmd>::SharedPtr motion_cmd_pub_{nullptr};
