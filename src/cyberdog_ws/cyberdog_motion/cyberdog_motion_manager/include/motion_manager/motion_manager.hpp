...
private:
  ...
  void OnlineAudioPlay(const std::string & text)
  {
    ...
    auto request = std::make_shared<cyberdog_protocol::srv::AudioTextPlay::Request>();
...
private:
  ...
  rclcpp::Client<cyberdog_protocol::srv::AudioTextPlay>::SharedPtr audio_client_{nullptr};
