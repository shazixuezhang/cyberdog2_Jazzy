...
#include "cyberdog_protocol/lcm/robot_control_cmd_lcmt.hpp"
...
private:
  ...
  {
    auto request = std::make_shared<cyberdog_protocol::srv::AudioTextPlay_Request>();
  ...
  rclcpp::Client<cyberdog_protocol::srv::AudioTextPlay>::SharedPtr audio_play_{nullptr};
