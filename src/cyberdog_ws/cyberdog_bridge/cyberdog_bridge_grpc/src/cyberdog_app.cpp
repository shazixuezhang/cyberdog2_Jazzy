...
using Navigation = cyberdog_protocol::action::Navigation;
  ...
  sn("")
{
  ...
  motion_servo_response_sub_ =
    this->create_subscription<cyberdog_protocol::msg::MotionServoResponse>(
  ...
  motion_servo_request_pub_ =
    this->create_publisher<cyberdog_protocol::msg::MotionServoCmd>(
    "motion_servo_cmd", rclcpp::SystemDefaultsQoS());

  motion_ressult_client_ = this->create_client<cyberdog_protocol::srv::MotionResultCmd>(
  ...
  ai_face_entry_client_ =
    this->create_client<cyberdog_protocol::srv::FaceEntry>("cyberdog_face_entry_srv");
  ai_face_recognition_client_ =
    this->create_client<cyberdog_protocol::srv::FaceRec>("cyberdog_face_recognition_srv");
  ai_face_entry_sub_ =
    this->create_subscription<cyberdog_protocol::msg::FaceEntryResult>(
    "face_entry_msg", rclcpp::SystemDefaultsQoS(),
    std::bind(&Cyberdog_app::face_entry_result_callback, this, _1));
  ai_face_recognition_sub_ =
    this->create_subscription<cyberdog_protocol::msg::FaceRecognitionResult>(
  ...
  audio_voiceprint_result_sub_ =
    this->create_subscription<cyberdog_protocol::msg::AudioVoiceprintResult>(
  ...
  audio_auth_request =
    this->create_client<cyberdog_protocol::srv::AudioAuthId>("get_authenticate_didsn");
  audio_auth_response = this->create_client<cyberdog_protocol::srv::AudioAuthToken>(
    "set_authenticate_token");
  audio_voiceprint_train =
    this->create_client<cyberdog_protocol::srv::AudioVoiceprintTrain>(
    "voiceprint_train");
  voiceprints_data_notify =
    this->create_client<cyberdog_protocol::srv::AudioVoiceprintsSet>(
    "voiceprints_data_notify");
  ...
  camera_service_client_ = this->create_client<cyberdog_protocol::srv::CameraService>(
    "camera_service");
  ...
  // ota
  download_subscriber_ = this->create_subscription<cyberdog_protocol::msg::OtaUpdate>(
    "ota_download_percentage", rclcpp::SystemDefaultsQoS(),
    std::bind(&Cyberdog_app::HandleDownloadPercentageMsgs, this, _1));

  upgrade_subscriber_ = this->create_subscription<cyberdog_protocol::msg::OtaUpdate>(
  ...
  bms_status_sub_ = this->create_subscription<cyberdog_protocol::msg::BmsStatus>(
    "bms_status", rclcpp::SystemDefaultsQoS(),
    std::bind(&Cyberdog_app::subscribeBmsStatus, this, std::placeholders::_1));

  ota_client_ = this->create_client<cyberdog_protocol::srv::OtaServerCmd>("ota_grpc");

  ota_action_client_ =
    rclcpp_action::create_client<cyberdog_protocol::action::OverTheAir>(
  ...
  query_dev_info_client_ =
    this->create_client<cyberdog_protocol::srv::DeviceInfo>("query_divice_info");
  ...
  dev_name_set_client_ =
    this->create_client<cyberdog_protocol::srv::AudioNickName>("set_nick_name");

  // audio volume set
  audio_volume_set_client_ =
    this->create_client<cyberdog_protocol::srv::AudioVolumeSet>("audio_volume_set");

  // audio mic set
  audio_execute_client_ =
    this->create_client<cyberdog_protocol::srv::AudioExecute>("set_audio_state");
  ...
  query_account_add_client_ =
    this->create_client<cyberdog_protocol::srv::AccountAdd>("account_add");

  // account member search
  query_account_search_client_ =
    this->create_client<cyberdog_protocol::srv::AccountSearch>("account_search");

  // account member delete
  query_account_delete_client_ =
    this->create_client<cyberdog_protocol::srv::AccountDelete>("account_delete");

  // account member change
  query_account_change_client_ =
    this->create_client<cyberdog_protocol::srv::AccountChange>("account_change");

  set_work_environment_client_ =
    this->create_client<cyberdog_protocol::srv::Trigger>("set_nx_environment");
  ...
  set_label_client_ = this->create_client<cyberdog_protocol::srv::SetMapLabel>(
    "set_label", rmw_qos_profile_services_default, callback_group_);

  get_label_client_ = this->create_client<cyberdog_protocol::srv::GetMapLabel>(
  ...
  stop_nav_action_client_ = this->create_client<cyberdog_protocol::srv::StopAlgoTask>(
  ...
  tracking_person_sub_ = create_subscription<cyberdog_protocol::msg::Person>(
    "person", tracking_qos,
    std::bind(&Cyberdog_app::publishTrackingPersonCB, this, _1));
  namecode_queue_size_[::grpcapi::SendRequest::TRACKING_OBJ] = 2;
  select_tracking_human_client_ = this->create_client<cyberdog_protocol::srv::BodyRegion>(
  ...
  scan_bluetooth_devices_client_ =
    this->create_client<cyberdog_protocol::srv::BLEScan>("scan_bluetooth_devices");
  connect_bluetooth_device_client_ =
    this->create_client<cyberdog_protocol::srv::BLEConnect>("connect_bluetooth_device");
  ...
  current_connected_bluetooth_client_ =
    this->create_client<cyberdog_protocol::srv::BLEScan>("get_connected_bluetooth_info");
  ble_battery_client_ =
    this->create_client<cyberdog_protocol::srv::GetBLEBatteryLevel>("ble_device_battery_level");
  ...
  ble_dfu_progress_sub_ = this->create_subscription<cyberdog_protocol::msg::BLEDFUProgress>(
  ...
  // status reporting
  motion_status_sub_ = this->create_subscription<cyberdog_protocol::msg::MotionStatus>(
    "motion_status", rclcpp::SystemDefaultsQoS(),
    std::bind(&Cyberdog_app::motionStatusCB, this, _1));
  task_status_sub_ = this->create_subscription<cyberdog_protocol::msg::AlgoTaskStatus>(
    "algo_task_status", rclcpp::SystemDefaultsQoS(),
    std::bind(&Cyberdog_app::taskStatusCB, this, _1));
  self_check_status_sub_ = this->create_subscription<cyberdog_protocol::msg::SelfCheckStatus>(
    "self_check_status", rclcpp::SystemDefaultsQoS(),
    std::bind(&Cyberdog_app::selfCheckStatusCB, this, _1));
  state_switch_status_sub_ = this->create_subscription<cyberdog_protocol::msg::StateSwitchStatus>(
    "state_switch_status", rclcpp::SystemDefaultsQoS(),
    std::bind(&Cyberdog_app::stateSwitchStatusCB, this, _1));
  bmd_status_sub_ = this->create_subscription<cyberdog_protocol::msg::BmsStatus>(
    "bms_status", rclcpp::SystemDefaultsQoS(),
  ...
  set_elec_skin_client_ = this->create_client<cyberdog_protocol::srv::ElecSkin>("set_elec_skin");
  ...
  unlock_develop_access_client_ =
    this->create_client<cyberdog_protocol::srv::Unlock>("unlock_develop_access");

  reboot_machine_client_ =
    this->create_client<cyberdog_protocol::srv::RebootMachine>("reboot_machine");
  ...
  connect_status_subscriber = this->create_subscription<cyberdog_protocol::msg::ConnectorStatus>(
...
void Cyberdog_app::subscribeConnectStatus(const cyberdog_protocol::msg::ConnectorStatus::SharedPtr msg)
{
  if (msg->is_connected) {
    if (!server_) {
...
void Cyberdog_app::subscribeBmsStatus(const cyberdog_protocol::msg::BmsStatus::SharedPtr msg)
{
  bms_status = *msg;
}
...
void Cyberdog_app::motion_servo_rsp_callback(
  const cyberdog_protocol::msg::MotionServoResponse::SharedPtr msg)
{
...
bool Cyberdog_app::callMotionServoCmd(
  const std::shared_ptr<cyberdog_protocol::srv::MotionResultCmd::Request> req,
  cyberdog_protocol::srv::MotionResultCmd::Response & rsp)
{
...
void Cyberdog_app::face_entry_result_callback(
  const cyberdog_protocol::msg::FaceEntryResult::SharedPtr msg)
{
...
void Cyberdog_app::face_rec_result_callback(
  const cyberdog_protocol::msg::FaceRecognitionResult::SharedPtr msg)
{
...
void Cyberdog_app::voiceprint_result_callback(
  const cyberdog_protocol::msg::AudioVoiceprintResult::SharedPtr msg)
{
  Document json_response(kObjectType);
  CyberdogJson::Add(json_response, "code", msg->code);
...
bool Cyberdog_app::callCameraService(uint8_t command, uint8_t & result, std::string & msg)
{
  ...
  auto request = std::make_shared<cyberdog_protocol::srv::CameraService::Request>();
  ...
  ::grpc::ServerWriter<::grpcapi::RecResponse> * writer)
{
  ...
  auto req = std::make_shared<cyberdog_protocol::srv::OtaServerCmd::Request>();
...
void Cyberdog_app::HandleDownloadPercentageMsgs(const cyberdog_protocol::msg::OtaUpdate msg)
{
...
void Cyberdog_app::HandleUpgradePercentageMsgs(const cyberdog_protocol::msg::OtaUpdate msg)
{
  Document progress_response(kObjectType);
  std::string response_string;
  ...
  bool create_new_task)
{
  ...
  auto action_goal = cyberdog_protocol::action::OverTheAir::Goal();
  ...
  auto feedback_callback =
    [&](rclcpp_action::Client<cyberdog_protocol::action::OverTheAir>::GoalHandle::SharedPtr goal_handel_ptr,
      const std::shared_ptr<const cyberdog_protocol::action::OverTheAir::Feedback> feedback) {
      writer_mutex.lock();
  ...
  std::shared_ptr<std::shared_ptr<cyberdog_protocol::action::OverTheAir::Result>> result_pp;
  std::shared_ptr<std::mutex> result_mx;
  size_t goal_hash = 0;
  {
    std::unique_lock<std::mutex> init_lock(task_init_mutex_);
    if (create_new_task) {
      bool acception = action_task_manager_.StartActionTask<cyberdog_protocol::action::OverTheAir>(
      ...
      if (ota_hash_itr == ota_hash_map_.end()) {
        ...
        accepted = action_task_manager_.AccessTask<cyberdog_protocol::action::OverTheAir>(
  ...
  bool create_new_task)
{
  ...
  if (!is_not_timeout) {
    ...
    if (result == cyberdog_protocol::action::Navigation::Result::NAVIGATION_RESULT_TYPE_SUCCESS) {
  ...
  ::grpc::ServerWriter<::grpcapi::RecResponse> * grpc_writer)
{
  ...
  auto request = std::make_shared<cyberdog_protocol::srv::GetMapLabel::Request>();
  ...
  if (status == std::future_status::ready) {
    if (future_result.get()->success ==
      cyberdog_protocol::srv::GetMapLabel_Response::RESULT_SUCCESS)
    {
      INFO("get_label services succeeded.");
    } else {
      WARN("get_label services failed.");
    }
    cyberdog_protocol::msg::MapLabel labels = future_result.get()->label;
...
void Cyberdog_app::handlLableSetRequest(
  ...
  ::grpc::ServerWriter<::grpcapi::RecResponse> * writer)
{
  cyberdog_protocol::msg::MapLabel map_label;
    ...
    json_request["locationLabelInfo"].IsArray())
  {
    ...
    for (int i = 0; i < labels.Size(); i++) {
      ...
      cyberdog_protocol::msg::Label label;
  ...
  auto request = std::make_shared<cyberdog_protocol::srv::SetMapLabel::Request>();
  ...
  if (status == std::future_status::ready) {
    if (future_result.get()->success ==
      cyberdog_protocol::srv::SetMapLabel_Response::RESULT_SUCCESS)
    {
...
void Cyberdog_app::publishTrackingPersonCB(const cyberdog_protocol::msg::Person::SharedPtr msg)
{
  rapidjson::StringBuffer strBuf;
  rapidjson::Writer<rapidjson::StringBuffer> writer(strBuf);
  writer.StartObject();
  ...
  ::grpc::ServerWriter<::grpcapi::RecResponse> * writer)
{
  ...
  auto req = std::make_shared<cyberdog_protocol::srv::BodyRegion::Request>();
  ...
  ::grpc::ServerWriter<::grpcapi::RecResponse> * writer)
{
  ...
  auto request = std::make_shared<cyberdog_protocol::srv::StopAlgoTask::Request>();
  ...
  ::grpc::ServerWriter<::grpcapi::RecResponse> * grpc_writer)
{
  ...
  auto req = std::make_shared<cyberdog_protocol::srv::BLEScan::Request>();
  ...
  ::grpc::ServerWriter<::grpcapi::RecResponse> * grpc_writer)
{
  ...
  auto req = std::make_shared<cyberdog_protocol::srv::BLEConnect::Request>();
  ...
  ::grpc::ServerWriter<::grpcapi::RecResponse> * grpc_writer)
{
  ...
  auto req = std::make_shared<cyberdog_protocol::srv::GetBLEBatteryLevel::Request>();
...
void Cyberdog_app::bleDFUProgressCB(const cyberdog_protocol::msg::BLEDFUProgress::SharedPtr msg)
{
  rapidjson::StringBuffer strBuf;
  rapidjson::Writer<rapidjson::StringBuffer> writer(strBuf);
  writer.StartObject();
...
void Cyberdog_app::motionStatusCB(const cyberdog_protocol::msg::MotionStatus::SharedPtr msg)
{
  std::unique_lock<std::shared_mutex> lock(status_mutex_);
  motion_status_.motion_id = msg->motion_id;
}

void Cyberdog_app::taskStatusCB(const cyberdog_protocol::msg::AlgoTaskStatus::SharedPtr msg)
{
  std::unique_lock<std::shared_mutex> lock(status_mutex_);
...
void Cyberdog_app::selfCheckStatusCB(const cyberdog_protocol::msg::SelfCheckStatus::SharedPtr msg)
{
  std::unique_lock<std::shared_mutex> lock(status_mutex_);
...
void Cyberdog_app::stateSwitchStatusCB(const cyberdog_protocol::msg::StateSwitchStatus::SharedPtr msg)
{
  std::unique_lock<std::shared_mutex> lock(status_mutex_);
...
void Cyberdog_app::bmsStatusCB(const cyberdog_protocol::msg::BmsStatus::SharedPtr msg)
{
  std::unique_lock<std::shared_mutex> lock(status_mutex_);
  ...
  ::grpc::ServerWriter<::grpcapi::RecResponse> * grpc_writer)
{
  ...
  auto req = std::make_shared<cyberdog_protocol::srv::Trigger::Request>();
  string data;
  ...
  ::grpc::ServerWriter<::grpcapi::RecResponse> * writer)
{
  ...
  std::chrono::seconds timeout(3);
  auto req = std::make_shared<cyberdog_protocol::srv::DeviceInfo::Request>();
  ...
  ::grpc::ServerWriter<::grpcapi::RecResponse> * writer)
{
  ...
  std::string rsp_string;
  std::chrono::seconds timeout(3);
  auto req = std::make_shared<cyberdog_protocol::srv::AccountAdd::Request>();
  ...
  ::grpc::ServerWriter<::grpcapi::RecResponse> * writer)
{
  ...
  std::chrono::seconds timeout(3);
  auto req = std::make_shared<cyberdog_protocol::srv::AccountSearch::Request>();
  ...
  ::grpc::ServerWriter<::grpcapi::RecResponse> * writer)
{
  ...
  auto req = std::make_shared<cyberdog_protocol::srv::AccountDelete::Request>();
  CyberdogJson::Get(json_request, "member", req->member);
  ...
  ::grpc::ServerWriter<::grpcapi::RecResponse> * writer)
{
  ...
  auto req = std::make_shared<cyberdog_protocol::srv::AccountChange::Request>();
...
void Cyberdog_app::motionServoRequestHandle(
  ...
  ::grpc::ServerWriter<::grpcapi::RecResponse> * writer)
{
  cyberdog_protocol::msg::MotionServoCmd motion_servo_cmd;
  ...
  ::grpc::ServerWriter<::grpcapi::RecResponse> * writer)
{
  ...
  auto req = std::make_shared<cyberdog_protocol::srv::MotionResultCmd::Request>();
  cyberdog_protocol::srv::MotionResultCmd::Response rsp;
  ...
  ::grpc::ServerWriter<::grpcapi::RecResponse> * writer)
{
  ...
  std::chrono::seconds timeout(3);
  auto req = std::make_shared<cyberdog_protocol::srv::FaceEntry::Request>();
  ...
  cyberdog_protocol::srv::FaceEntry::Response rsp;
  ...
  ::grpc::ServerWriter<::grpcapi::RecResponse> * writer)
{
  ...
  std::chrono::seconds timeout(3);
  auto req = std::make_shared<cyberdog_protocol::srv::FaceRec::Request>();
  CyberdogJson::Get(json_request, "command", req->command);
  CyberdogJson::Get(json_request, "username", req->username);
  cyberdog_protocol::srv::FaceRec::Response rsp;
  ...
  ::grpc::ServerWriter<::grpcapi::RecResponse> * writer)
{
  ...
  std::chrono::seconds timeout(3);
  auto req = std::make_shared<cyberdog_protocol::srv::AudioNickName::Request>();
  ...
  ::grpc::ServerWriter<::grpcapi::RecResponse> * writer)
{
  ...
  std::chrono::seconds timeout(3);
  auto req = std::make_shared<cyberdog_protocol::srv::AudioVolumeSet::Request>();
  int volume;
  ...
  ::grpc::ServerWriter<::grpcapi::RecResponse> * writer)
{
  ...
  std::chrono::seconds timeout(3);
  auto req = std::make_shared<cyberdog_protocol::srv::AudioExecute::Request>();
  req->client = "app_server";
  bool enable;
  CyberdogJson::Get(json_request, "enable", enable);
  req->status.state =
    (enable ==
    true) ? cyberdog_protocol::msg::AudioStatus::AUDIO_STATUS_NORMAL : cyberdog_protocol::msg::AudioStatus::
    AUDIO_STATUS_OFFMIC;
  ...
  ::grpc::ServerWriter<::grpcapi::RecResponse> * writer)
{
  ...
  std::chrono::seconds timeout(3);
  auto req = std::make_shared<cyberdog_protocol::srv::AudioAuthId::Request>();
  cyberdog_protocol::srv::AudioAuthId::Response rsp;
  ...
  ::grpc::ServerWriter<::grpcapi::RecResponse> * writer)
{
  ...
  std::chrono::seconds timeout(3);
  auto req = std::make_shared<cyberdog_protocol::srv::AudioAuthToken::Request>();
  cyberdog_protocol::srv::AudioAuthToken::Response rsp;
  ...
  ::grpc::ServerWriter<::grpcapi::RecResponse> * writer)
{
  ...
  std::chrono::seconds timeout(3);
  auto req = std::make_shared<cyberdog_protocol::srv::AudioVoiceprintTrain::Request>();
  req->train_id = cyberdog_protocol::srv::AudioVoiceprintTrain::Request::TID_START;
  ...
  ::grpc::ServerWriter<::grpcapi::RecResponse> * writer)
{
  ...
  std::chrono::seconds timeout(3);
  auto req = std::make_shared<cyberdog_protocol::srv::AudioVoiceprintTrain::Request>();
  req->train_id = cyberdog_protocol::srv::AudioVoiceprintTrain::Request::TID_CANCEL;
  auto future_result = audio_voiceprint_train->async_send_request(req);
  std::future_status status = future_result.wait_for(timeout);
  if (status == std::future_status::ready) {
    INFO(
  ...
  ::grpc::ServerWriter<::grpcapi::RecResponse> * writer)
{
  ...
  std::chrono::seconds timeout(3);
  auto req = std::make_shared<cyberdog_protocol::srv::AudioVoiceprintsSet::Request>();
  ...
  ::grpc::ServerWriter<::grpcapi::RecResponse> * writer)
{
  ...
  auto req = std::make_shared<cyberdog_protocol::srv::Unlock::Request>();
  ...
  ::grpc::ServerWriter<::grpcapi::RecResponse> * writer)
{
  ...
  auto req = std::make_shared<cyberdog_protocol::srv::RebootMachine::Request>();
  ...
  ::grpc::ServerWriter<::grpcapi::RecResponse> * grpc_writer)
{
  ...
  auto req = std::make_shared<cyberdog_protocol::srv::ElecSkin::Request>();
