...
#include "cyberdog_protocol/msg/manager_state.hpp"
#include "cyberdog_protocol/msg/heartbeats.hpp"
#include "cyberdog_protocol/srv/manager_init.hpp"
...
class ManagerBase
{
  using ManagerStateMsg = cyberdog_protocol::msg::ManagerState;
  using ManagerHeartbeatsMsg = cyberdog_protocol::msg::Heartbeats;
  using ManagerInitSrv = cyberdog_protocol::srv::ManagerInit;
...
private:
  ...
  {
    auto msg = cyberdog_protocol::msg::Heartbeats();
    msg.name = name_;
