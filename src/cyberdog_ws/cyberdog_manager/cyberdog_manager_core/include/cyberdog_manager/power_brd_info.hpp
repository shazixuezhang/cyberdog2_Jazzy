...
public:
  ...
  : power_brd_info_node_(node_ptr)
  {
    ...
    motion_excute_client_ =
      power_brd_info_node_->create_client<cyberdog_protocol::srv::MotionResultCmd>(
      "motion_result_cmd",
    ...
    bes_http_send_event_client_ =
      ...
      cyberdog_protocol::srv::BesHttpSendFile>(
...
private:
  ...
  bool SendEvent(const std::string & msg)
  {
    ...
    auto request = std::make_shared<cyberdog_protocol::srv::BesHttpSendFile::Request>();
    request->method = cyberdog_protocol::srv::BesHttpSendFile::Request::HTTP_METHOD_POST;
...
private:
  ...
  rclcpp::Client<cyberdog_protocol::srv::BesHttpSendFile>::SharedPtr bes_http_send_event_client_;
};
}  // namespace manager
}  // namespace cyberdog
