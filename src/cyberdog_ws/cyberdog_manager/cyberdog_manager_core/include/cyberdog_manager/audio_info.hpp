...
{
  using AudioMsg = cyberdog_protocol::msg::AudioPlayExtend;
...
public:
  ...
  : audio_info_node_(node_ptr)
  {
    ...
    audio_text_play_client_ =
      audio_info_node_->create_client<cyberdog_protocol::srv::AudioTextPlay>(
      "speech_text_play",
      rmw_qos_profile_services_default, audio_callback_group_);
    sdcard_playid_query_client_ =
      audio_info_node_->create_client<cyberdog_protocol::srv::SdcardPlayIdQuery>(
      "SdcardPlayIdQuery",
      rmw_qos_profile_services_default, audio_callback_group_);
  }
  ...
  void Init()
  {
    if (!init_) {
      ...
      auto req = std::make_shared<cyberdog_protocol::srv::AudioTextPlay::Request>();
      req->module_name = audio_info_node_->get_name();
      req->is_online = false;
      req->speech.play_id = cyberdog_protocol::msg::AudioPlay::PID_SOUND_EFFECT_READY;
      ...
      text_msg.speech.play_id = cyberdog_protocol::msg::AudioPlay::PID_SELF_CHECK_SUCCESS;
  ...
  void Error(std::string error_text)
  {
    ...
    text_msg.module_name = audio_info_node_->get_name();
    text_msg.is_online = false;
    text_msg.speech.play_id = cyberdog_protocol::msg::AudioPlay::PID_SELF_CHECK_FAILED;
...
private:
  ...
  rclcpp::Client<cyberdog_protocol::srv::AudioTextPlay>::SharedPtr audio_text_play_client_ {nullptr};
  rclcpp::Client<cyberdog_protocol::srv::SdcardPlayIdQuery>::SharedPtr sdcard_playid_query_client_ {nullptr};
  bool init_ {false};
