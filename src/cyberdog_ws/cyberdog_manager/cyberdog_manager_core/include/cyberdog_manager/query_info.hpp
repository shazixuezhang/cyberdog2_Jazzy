...
#include "cyberdog_protocol/srv/motor_temp.hpp"
...
#include "cyberdog_protocol/srv/uid_sn.hpp"
...
public:
  explicit QueryInfo(rclcpp::Node::SharedPtr node_ptr)
  {
    ...
    audio_volume_get_client_ =
      query_node_ptr_->create_client<cyberdog_protocol::srv::AudioVolumeGet>(
      "audio_volume_get",
      rmw_qos_profile_services_default, qdev_callback_group_);
    audio_execute_client_ =
      query_node_ptr_->create_client<cyberdog_protocol::srv::AudioExecute>(
      "get_audio_state",
      rmw_qos_profile_services_default, qdev_callback_group_);
    ...
    motor_temper_client_ =
      query_node_ptr_->create_client<cyberdog_protocol::srv::MotorTemp>(
      "motor_temp",
      rmw_qos_profile_services_default, qdev_callback_group_);
    audio_active_state_client_ =
      query_node_ptr_->create_client<cyberdog_protocol::srv::Trigger>(
      "audio_active_state",
      rmw_qos_profile_services_default, qdev_callback_group_);
    low_power_switch_state_client_ =
      ...
      rmw_qos_profile_services_default, qdev_callback_group_);
    version_get_client_ = rclcpp_action::create_client<cyberdog_protocol::action::OverTheAir>(
      query_node_ptr_,
      "cyberdog_ota_action");
  }
  ...
  void SetBms(cyberdog_protocol::msg::BmsStatus & bms_status)
  {
  ...
  cyberdog_protocol::msg::BmsStatus & GetBms()
  {
    return bms_status_;
  }
  ...
  const std::string QueryDeviceInfo(std::vector<bool> & enables, std::string app_uid = "")
  {
    ...
    if (is_volume) {
      if (!audio_volume_get_client_->wait_for_service(std::chrono::seconds(2))) {
        ...
        std::chrono::seconds timeout(3);
        auto req = std::make_shared<cyberdog_protocol::srv::AudioVolumeGet::Request>();
    ...
    if (is_motor_temper) {
      ...
      if (!motor_temper_client_->wait_for_service(std::chrono::seconds(2))) {
        ...
        std::chrono::seconds timeout(3);
        auto req = std::make_shared<cyberdog_protocol::srv::MotorTemp::Request>();
  ...
  void GetVersion()
  {
    if (!version_get_client_->wait_for_action_server(std::chrono::seconds(5))) {
      ...
      auto goal = cyberdog_protocol::action::OverTheAir::Goal();
      goal.id = "query_divice_info";
      goal.operate = "inquire";
      goal.user = "cyberdog_manager";
      auto send_goal_options =
        rclcpp_action::Client<cyberdog_protocol::action::OverTheAir>::SendGoalOptions();
      using GoalHandleOverTheAir = rclcpp_action::ClientGoalHandle<cyberdog_protocol::action::OverTheAir>;
...
private:
  ...
  cyberdog_protocol::msg::BmsStatus bms_status_;
  bool standed_{false};
  ...
  rclcpp::Client<cyberdog_protocol::srv::AudioVolumeGet>::SharedPtr audio_volume_get_client_;
  ...
  rclcpp::Client<cyberdog_protocol::srv::MotorTemp>::SharedPtr motor_temper_client_;
  rclcpp::Client<cyberdog_protocol::srv::Trigger>::SharedPtr audio_active_state_client_;
  rclcpp::Client<std_srvs::srv::Trigger>::SharedPtr low_power_switch_state_client_;
  rclcpp_action::Client<cyberdog_protocol::action::OverTheAir>::SharedPtr version_get_client_;
};
...
public:
  ...
  : uid_("")
  {
    ...
    device_info_get_srv_ =
      query_info_node_->create_service<cyberdog_protocol::srv::DeviceInfo>(
      "query_divice_info",
      std::bind(
    ...
    dog_info_update_sub_ =
      ...
      sub_options);
    uid_sn_srv_ =
      query_info_node_->create_service<cyberdog_protocol::srv::UidSn>(
      "uid_sn",
      std::bind(
        &QueryInfoNode::UidSn, this, std::placeholders::_1,
        std::placeholders::_2));
    motion_status_sub_ =
      query_info_node_->create_subscription<cyberdog_protocol::msg::MotionStatus>(
      "motion_status", rclcpp::SystemDefaultsQoS(),
      std::bind(&QueryInfoNode::MotionStatus, this, std::placeholders::_1),
      sub_options);
    connect_status_sub_ = query_info_node_->create_subscription<cyberdog_protocol::msg::ConnectorStatus>(
      "connector_state", rclcpp::SystemDefaultsQoS(),
      std::bind(&QueryInfoNode::ConnectStatus, this, std::placeholders::_1),
      sub_options);
    bms_status_sub_ = query_info_node_->create_subscription<cyberdog_protocol::msg::BmsStatus>(
    ...
    dev_name_set_client_ =
      query_info_node_->create_client<cyberdog_protocol::srv::AudioNickName>(
      "set_nick_name",
...
private:
  void QueryDeviceInfo(
    const cyberdog_protocol::srv::DeviceInfo::Request::SharedPtr request,
    cyberdog_protocol::srv::DeviceInfo::Response::SharedPtr response)
  {
    Document json_info(kObjectType);
    std::string info;
  ...
  void UidSn(
    const cyberdog_protocol::srv::UidSn::Request::SharedPtr request,
    cyberdog_protocol::srv::UidSn::Response::SharedPtr response)
  {
    (void) request;
  ...
  void MotionStatus(const cyberdog_protocol::msg::MotionStatus::SharedPtr msg)
  {
    // get standing state
    int motion_state = msg->motion_id;
    if (motion_state == cyberdog_protocol::msg::MotionID::RECOVERYSTAND) {
  ...
  void ConnectStatus(const cyberdog_protocol::msg::ConnectorStatus::SharedPtr msg)
  {
    if (msg->is_connected) {
...
private:
  ...
  rclcpp::Service<cyberdog_protocol::srv::DeviceInfo>::SharedPtr device_info_get_srv_;
  ...
  rclcpp::Service<cyberdog_protocol::srv::UidSn>::SharedPtr uid_sn_srv_;
  rclcpp::Subscription<cyberdog_protocol::msg::MotionStatus>::SharedPtr motion_status_sub_;
  rclcpp::Subscription<cyberdog_protocol::msg::ConnectorStatus>::SharedPtr connect_status_sub_;
