...
public:
  ...
  : led_info_node_(node_ptr)
  {
    ...
    led_excute_client_ =
      led_info_node_->create_client<cyberdog_protocol::srv::LedExecute>(
      "led_execute",
...
private:
  void ReqAssignment(std::shared_ptr<cyberdog_protocol::srv::LedExecute::Request> req, LedMode & data)
  {
...
private:
  ...
  rclcpp::Client<cyberdog_protocol::srv::LedExecute>::SharedPtr led_excute_client_ {nullptr};
