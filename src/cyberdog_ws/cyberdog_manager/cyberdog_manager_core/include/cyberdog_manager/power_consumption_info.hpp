...
public:
  ...
  : enter_lowpower_handler(callback)
  {
    ...
    led_excute_client_ =
      power_consumption_info_node_->create_client<cyberdog_protocol::srv::LedExecute>(
      "led_execute",
      rmw_qos_profile_services_default, power_consumption_callback_group_);
    motion_excute_client_ =
      power_consumption_info_node_->create_client<cyberdog_protocol::srv::MotionResultCmd>(
      "motion_result_cmd",
      rmw_qos_profile_services_default, power_consumption_callback_group_);
    ...
    audio_play_extend_pub_ =
      power_consumption_info_node_->create_publisher<cyberdog_protocol::msg::AudioPlayExtend>(
      "speech_play_extend",
    ...
    state_swith_status_sub_ = power_consumption_info_node_->
      create_subscription<cyberdog_protocol::msg::StateSwitchStatus>(
  ...
  void Init()
  {
    ...
    motion_status_sub_ = power_consumption_info_node_->
      create_subscription<cyberdog_protocol::msg::MotionStatus>(
  ...
  void TailLedControl(bool is_light_off, bool is_exiting = false)
  {
    ...
    auto request_led = std::make_shared<cyberdog_protocol::srv::LedExecute::Request>();
...
private:
  void sub_mostion_status_callback(const cyberdog_protocol::msg::MotionStatus::SharedPtr msg)
  {
    // 状态机切换也有判断
    if (is_ota_) {
  ...
  void sub_state_switch_status_callback(const cyberdog_protocol::msg::StateSwitchStatus::SharedPtr msg)
  {
    if (msg->state == 3) {
      is_ota_ = true;
    } else {
...
private:
  ...
  rclcpp::Client<cyberdog_protocol::srv::LedExecute>::SharedPtr led_excute_client_;
  ...
  rclcpp::Subscription<cyberdog_protocol::msg::MotionStatus>::SharedPtr motion_status_sub_ {nullptr};
  rclcpp::Publisher<cyberdog_protocol::msg::AudioPlayExtend>::SharedPtr audio_play_extend_pub_ {nullptr};
  rclcpp::Subscription<cyberdog_protocol::msg::StateSwitchStatus>::SharedPtr \
