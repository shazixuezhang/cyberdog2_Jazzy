...
#include "cyberdog_protocol/srv/machine_state.hpp"
...
public:
  ...
  : mssc_node_(node_ptr)
  {
    ...
    machine_state_switch_keep_srv_ =
      mssc_node_->create_service<cyberdog_protocol::srv::MachineState>(
    ...
    state_swith_status_pub_ =
      mssc_node_->create_publisher<cyberdog_protocol::msg::StateSwitchStatus>(
...
private:
  ...
  void MachineStateSwitchKeep(
    const cyberdog_protocol::srv::MachineState::Request::SharedPtr request,
    cyberdog_protocol::srv::MachineState::Response::SharedPtr response)
  {
    if (!machine_state_keep_) {
      if (request->ticks > 0) {
        {
...
private:
  ...
  rclcpp::Service<cyberdog_protocol::srv::MachineState>::SharedPtr machine_state_switch_keep_srv_;
