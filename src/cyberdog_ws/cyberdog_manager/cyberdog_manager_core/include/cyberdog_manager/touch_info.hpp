...
public:
  explicit TouchInfoNode(rclcpp::Node::SharedPtr node_ptr)
  {
    ...
    touch_status_sub_ = touch_info_node_->create_subscription<cyberdog_protocol::msg::TouchStatus>(
      "touch_status", rclcpp::SystemDefaultsQoS(),
      std::bind(&TouchInfoNode::ReportPower, this, std::placeholders::_1), sub_options);

    bms_status_sub_ = touch_info_node_->create_subscription<cyberdog_protocol::msg::BmsStatus>(
      "bms_status", rclcpp::SystemDefaultsQoS(),
      std::bind(&TouchInfoNode::BmsStatus, this, std::placeholders::_1), sub_options);

    StateSwitch_sub = touch_info_node_->create_subscription<cyberdog_protocol::msg::StateSwitchStatus>(
    ...
    audio_play_extend_pub =
      touch_info_node_->create_publisher<cyberdog_protocol::msg::AudioPlayExtend>(
...
private:
  void ReportPower(const cyberdog_protocol::msg::TouchStatus::SharedPtr msg)
  {
  ...
  void SelfCheckCallback(const cyberdog_protocol::msg::StateSwitchStatus::SharedPtr msg)
  {
    if (msg->state == 2) {
      is_low_power = true;
...
private:
  ...
  rclcpp::Subscription<cyberdog_protocol::msg::TouchStatus>::SharedPtr touch_status_sub_;
  ...
  rclcpp::Subscription<cyberdog_protocol::msg::StateSwitchStatus>::SharedPtr StateSwitch_sub;
