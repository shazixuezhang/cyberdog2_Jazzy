...
public:
  explicit AccountInfoNode(rclcpp::Node::SharedPtr node_ptr)
  {
    ...
    account_add_srv_ =
      account_info_node_->create_service<cyberdog_protocol::srv::AccountAdd>(
      "account_add",
      std::bind(
    ...
    account_search_srv_ =
      account_info_node_->create_service<cyberdog_protocol::srv::AccountSearch>(
      "account_search",
      std::bind(
      ...
      rmw_qos_profile_services_default, account_callback_group_);
    account_delete_srv_ =
      account_info_node_->create_service<cyberdog_protocol::srv::AccountDelete>(
      "account_delete",
      std::bind(
      ...
      rmw_qos_profile_services_default, account_callback_group_);
    account_search_all_ =
      account_info_node_->create_service<cyberdog_protocol::srv::AllUserSearch>(
      "all_user_search",
      std::bind(
      ...
      rmw_qos_profile_services_default, account_callback_group_);
    account_change_srv_ =
      account_info_node_->create_service<cyberdog_protocol::srv::AccountChange>(
      "account_change",
      std::bind(
...
private:
  void AllUserSearch(
    const cyberdog_protocol::srv::AllUserSearch::Request::SharedPtr request,
    cyberdog_protocol::srv::AllUserSearch::Response::SharedPtr response)
  {
  ...
  void QueryAccountAdd(
    const cyberdog_protocol::srv::AccountAdd::Request::SharedPtr request,
    cyberdog_protocol::srv::AccountAdd::Response::SharedPtr response)
  {
  ...
  void QueryAccountSearch(
    const cyberdog_protocol::srv::AccountSearch::Request::SharedPtr request,
    cyberdog_protocol::srv::AccountSearch::Response::SharedPtr response)
  {
  ...
  void QueryAccountDelete(
    const cyberdog_protocol::srv::AccountDelete::Request::SharedPtr request,
    cyberdog_protocol::srv::AccountDelete::Response::SharedPtr response)
  {
    INFO("enter delete account callback");
    std::chrono::seconds timeout(3);
    // voice delete
    rclcpp::Client<cyberdog_protocol::srv::AudioVoiceprintEntry>::SharedPtr voice_delete_client_;
    voice_delete_client_ =
      account_info_node_->create_client<cyberdog_protocol::srv::AudioVoiceprintEntry>(
    ...
    auto request_voice = std::make_shared<cyberdog_protocol::srv::AudioVoiceprintEntry::Request>();
    ...
    // face delete
    rclcpp::Client<cyberdog_protocol::srv::FaceEntry>::SharedPtr face_delete_client_;
    face_delete_client_ =
      account_info_node_->create_client<cyberdog_protocol::srv::FaceEntry>("cyberdog_face_entry_srv");
    ...
    auto request_face = std::make_shared<cyberdog_protocol::srv::FaceEntry::Request>();
  ...
  void ChangeUserName(
    const cyberdog_protocol::srv::AccountChange::Request::SharedPtr request,
    cyberdog_protocol::srv::AccountChange::Response::SharedPtr response)
  {
...
private:
  ...
  rclcpp::Service<cyberdog_protocol::srv::AccountAdd>::SharedPtr account_add_srv_;
  rclcpp::Service<cyberdog_protocol::srv::AccountSearch>::SharedPtr account_search_srv_;
  rclcpp::Service<cyberdog_protocol::srv::AccountDelete>::SharedPtr account_delete_srv_;
  rclcpp::Service<cyberdog_protocol::srv::AllUserSearch>::SharedPtr account_search_all_;
  rclcpp::Service<cyberdog_protocol::srv::AccountChange>::SharedPtr account_change_srv_;
};
