...
void cyberdog::sensor::SensorManager::Config()
{
  ...
  gps_publisher_ = node_ptr_->create_publisher<cyberdog_protocol::msg::GpsPayload>(
    "gps_payload",
  ...
  head_tof_publisher_ = node_ptr_->create_publisher<cyberdog_protocol::msg::HeadTofPayload>(
    "head_tof_payload", rclcpp::SystemDefaultsQoS());
  rear_tof_publisher_ = node_ptr_->create_publisher<cyberdog_protocol::msg::RearTofPayload>(
  ...
  head_tof_payload = std::make_shared<cyberdog_protocol::msg::HeadTofPayload>();
  rear_tof_payload = std::make_shared<cyberdog_protocol::msg::RearTofPayload>();
  ...
  sensor_operation_srv_ = node_ptr_->create_service<cyberdog_protocol::srv::SensorOperation>(
    "sensor_operation",
    std::bind(
  ...
  T elem, uint8_t oper_id)
{
  ...
  int32_t code;
  switch (oper_id) {
    case cyberdog_protocol::srv::SensorOperation::Request::OPR_OPEN:
      {
        code = elem->Open();
        result = (IS_OK(code) > 0) ? false : true;
        break;
      }
    case cyberdog_protocol::srv::SensorOperation::Request::OPR_START:
      {
        code = elem->Start();
        result = (IS_OK(code) > 0) ? false : true;
        break;
      }
    case cyberdog_protocol::srv::SensorOperation::Request::OPR_STOP:
      {
        code = elem->Stop();
        result = (IS_OK(code) > 0) ? false : true;
        break;
      }
    case cyberdog_protocol::srv::SensorOperation::Request::OPR_CLOSE:
      {
        code = elem->Close();
        result = (IS_OK(code) > 0) ? false : true;
        break;
...
void cyberdog::sensor::SensorManager::gps_payload_callback(
  std::shared_ptr<cyberdog_protocol::msg::GpsPayload> msg)
{
...
void cyberdog::sensor::SensorManager::SingleTofPayloadCallback(
  std::shared_ptr<cyberdog_protocol::msg::SingleTofPayload> msg)
{
  if (msg->header.frame_id == "left_rear_tof" || msg->header.frame_id == "right_rear_tof") {
    ...
    if (msg->header.frame_id == "left_rear_tof") {
      ...
      rear_tof_payload->left_rear.tof_position = cyberdog_protocol::msg::SingleTofPayload::LEFT_REAR;
    } else {
      rear_tof_.at(msg->header.frame_id) = true;
      rear_tof_payload->right_rear = *msg;
      rear_tof_payload->right_rear.header.frame_id = "right_rear";
      rear_tof_payload->right_rear.tof_position = cyberdog_protocol::msg::SingleTofPayload::RIGHT_REAR;
    }
    ...
    if (msg->header.frame_id == "left_head_tof") {
      ...
      head_tof_payload->left_head.tof_position = cyberdog_protocol::msg::SingleTofPayload::LEFT_HEAD;
    } else {
      head_tof_.at(msg->header.frame_id) = true;
      head_tof_payload->right_head = *msg;
      head_tof_payload->right_head.header.frame_id = "right_head";
      head_tof_payload->right_head.tof_position = cyberdog_protocol::msg::SingleTofPayload::RIGHT_HEAD;
    }
...
void cyberdog::sensor::SensorManager::sensor_operation(
  const cyberdog_protocol::srv::SensorOperation::Request::SharedPtr request,
  cyberdog_protocol::srv::SensorOperation::Response::SharedPtr response)
{
  auto sensor_tuple = std::make_tuple(lidar_, ultrasonic_, tof_, gps_);
  response->success = true;
  switch (request->sensor_id) {
    case cyberdog_protocol::srv::SensorOperation::Request::ID_ALL:
      {
        response->success &=
          SensorOperation<decltype(std::get<cyberdog_protocol::srv::SensorOperation::Request::ID_LIDAR -
            1>(sensor_tuple))>(
          std::get<cyberdog_protocol::srv::SensorOperation::Request::ID_LIDAR -
          1>(sensor_tuple),
          request->operation);
        response->success &=
          SensorOperation<decltype(std::get<cyberdog_protocol::srv::SensorOperation::Request::ID_ULTRA -
            1>(sensor_tuple))>(
          std::get<cyberdog_protocol::srv::SensorOperation::Request::ID_ULTRA -
          1>(sensor_tuple),
          request->operation);
        response->success &=
          SensorOperation<decltype(std::get<cyberdog_protocol::srv::SensorOperation::Request::ID_TOF -
            1>(sensor_tuple))>(
          std::get<cyberdog_protocol::srv::SensorOperation::Request::ID_TOF -
          1>(sensor_tuple),
          request->operation);
        response->success &=
          SensorOperation<decltype(std::get<cyberdog_protocol::srv::SensorOperation::Request::ID_GPS -
            1>(sensor_tuple))>(
          std::get<cyberdog_protocol::srv::SensorOperation::Request::ID_GPS -
          1>(sensor_tuple),
          request->operation);
      }
      break;

    case cyberdog_protocol::srv::SensorOperation::Request::ID_LIDAR:
      {
        response->success =
          SensorOperation<decltype(std::get<cyberdog_protocol::srv::SensorOperation::Request::ID_LIDAR -
            1>(sensor_tuple))>(
    ...
    case cyberdog_protocol::srv::SensorOperation::Request::ID_ULTRA:
      {
        response->success =
          SensorOperation<decltype(std::get<cyberdog_protocol::srv::SensorOperation::Request::ID_ULTRA -
            1>(sensor_tuple))>(
    ...
    case cyberdog_protocol::srv::SensorOperation::Request::ID_TOF:
      {
        response->success =
          SensorOperation<decltype(std::get<cyberdog_protocol::srv::SensorOperation::Request::ID_TOF -
            1>(sensor_tuple))>(
    ...
    case cyberdog_protocol::srv::SensorOperation::Request::ID_GPS:
      {
        response->success =
          SensorOperation<decltype(std::get<cyberdog_protocol::srv::SensorOperation::Request::ID_GPS -
            1>(sensor_tuple))>(
