...
#include "cyberdog_protocol/srv/sensor_operation.hpp"
...
private:
  ...
  rclcpp::Publisher<cyberdog_protocol::msg::GpsPayload>::SharedPtr gps_publisher_;
  void gps_payload_callback(std::shared_ptr<cyberdog_protocol::msg::GpsPayload> msg);
  ...
  rclcpp::Publisher<cyberdog_protocol::msg::HeadTofPayload>::SharedPtr head_tof_publisher_;
  rclcpp::Publisher<cyberdog_protocol::msg::RearTofPayload>::SharedPtr rear_tof_publisher_;
  std::shared_ptr<cyberdog_protocol::msg::HeadTofPayload> head_tof_payload;
  std::shared_ptr<cyberdog_protocol::msg::RearTofPayload> rear_tof_payload;
  ...
  void SingleTofPayloadCallback(std::shared_ptr<cyberdog_protocol::msg::SingleTofPayload> msg);

  rclcpp::Service<cyberdog_protocol::srv::SensorOperation>::SharedPtr sensor_operation_srv_;
