  ...
  name_(name)
{
  ...
  if (!is_active) {
    ...
    led_service_ = node_ptr->create_service<cyberdog_protocol::srv::LedExecute>(
      "led_execute",
      std::bind(
    ...
    bms_service_ = node_ptr->create_service<cyberdog_protocol::srv::BmsCmd>(
      "bms_cmd",
      std::bind(
    ...
    uwb_service_ = node_ptr->create_service<cyberdog_protocol::srv::GetUWBMacSessionID>(
