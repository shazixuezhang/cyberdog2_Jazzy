...
private:
  ...
  rclcpp::Service<cyberdog_protocol::srv::LedExecute>::SharedPtr led_service_ {nullptr};
  rclcpp::Service<cyberdog_protocol::srv::BmsCmd>::SharedPtr bms_service_ {nullptr};
  rclcpp::Service<cyberdog_protocol::srv::GetUWBMacSessionID>::SharedPtr uwb_service_ {nullptr};
