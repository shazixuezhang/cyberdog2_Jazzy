...
using LedExecuteRequest = cyberdog_protocol::srv::LedExecute::Request;
using LedExecuteResponse = cyberdog_protocol::srv::LedExecute::Response;
...
private:
  ...
  void find_cmd(
    const std::shared_ptr<cyberdog_protocol::srv::LedExecute::Request> info_request,
    Request_Attribute & operatecmd);
  int32_t request_legal(const std::shared_ptr<cyberdog_protocol::srv::LedExecute::Request> info_request);
...
public:
  ...
  void Play(
    const std::shared_ptr<cyberdog_protocol::srv::LedExecute::Request> info_request,
    std::shared_ptr<cyberdog_protocol::srv::LedExecute::Response> info_response) override;
};  // class LedCarpo
}  // namespace device
}  // namespace cyberdog
