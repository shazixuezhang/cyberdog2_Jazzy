...
void BMSCarpo::ServiceCommand(
  ...
  std::shared_ptr<cyberdog_protocol::srv::BmsCmd::Response> response)
{
...
void BMSCarpo::BatteryMsgCall(EP::DataLabel & label, std::shared_ptr<BatteryMsg> data)
{
  ...
  auto MsgCallback = [&]() {
      cyberdog_protocol::msg::BmsStatus message;
      // message.header
      ...
      static cyberdog_protocol::msg::BmsStatus previous_message = message;
