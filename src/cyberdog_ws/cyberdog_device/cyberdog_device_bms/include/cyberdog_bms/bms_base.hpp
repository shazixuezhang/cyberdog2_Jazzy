...
{
public:
  using BmsStatusMsg = cyberdog_protocol::msg::BmsStatus;
  ...
  virtual void ServiceCommand(
    const std::shared_ptr<cyberdog_protocol::srv::BmsCmd::Request> request,
    std::shared_ptr<cyberdog_protocol::srv::BmsCmd::Response> response) = 0;
