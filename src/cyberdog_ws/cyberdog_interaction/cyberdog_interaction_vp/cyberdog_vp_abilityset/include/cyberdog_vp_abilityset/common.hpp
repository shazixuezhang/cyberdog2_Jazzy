...
include <cyberdog_protocol/msg/user_information.hpp>
include <cyberdog_protocol/msg/face_recognition_result.hpp>
include <cyberdog_protocol/msg/gesture_action_result.hpp>
include <cyberdog_protocol/msg/motion_sequence_pace.hpp>
...
include <cyberdog_protocol/msg/motion_id.hpp>
include <cyberdog_protocol/msg/bms_status.hpp>
include <cyberdog_protocol/msg/touch_status.hpp>
include <cyberdog_protocol/msg/head_tof_payload.hpp>
include <cyberdog_protocol/msg/rear_tof_payload.hpp>
include <cyberdog_protocol/msg/gps_payload.hpp>
include <cyberdog_protocol/msg/single_tof_payload.hpp>
...
include <cyberdog_protocol/msg/sport_counts_result.hpp>
include <cyberdog_protocol/msg/algo_task_status.hpp>
include <cyberdog_protocol/msg/visual_programming_operate.hpp>

include <cyberdog_protocol/srv/visual_programming_operate.hpp>
...
include <cyberdog_protocol/srv/motion_sequence_show.hpp>
include <cyberdog_protocol/srv/all_user_search.hpp>
include <cyberdog_protocol/srv/face_rec.hpp>
include <cyberdog_protocol/srv/gesture_action_control.hpp>
include <cyberdog_protocol/srv/get_map_label.hpp>
include <cyberdog_protocol/srv/stop_algo_task.hpp>
include <cyberdog_protocol/srv/sport_manager.hpp>
include <cyberdog_protocol/srv/train_plan_all.hpp>
...
using MsgMotionID = cyberdog_protocol::msg::MotionID;      /*!< 运动 id */
using MsgMotionServoCmd =
  cyberdog_protocol::msg::MotionServoCmd;                  /*!< 伺服指令 */
using MsgMotionStatus =
  cyberdog_protocol::msg::MotionStatus;                    /*!< 运动状态 */
using MsgSingleTofPayload =
  cyberdog_protocol::msg::SingleTofPayload;                /*!< 单个tof数据 */
using MsgHeadTofPayload =
  cyberdog_protocol::msg::HeadTofPayload;                  /*!< 头部tof数据 */
using MsgRearTofPayload =
  cyberdog_protocol::msg::RearTofPayload;                  /*!< 尾部tof数据 */
using MsgGpsPayload = cyberdog_protocol::msg::GpsPayload;  /*!< GPS数据 */
using MsgAudioPlayExtend =
  cyberdog_protocol::msg::AudioPlayExtend;                 /*!< 语音消息:在线 */
using MsgAudioPlay = cyberdog_protocol::msg::AudioPlay;    /*!< 语音消息:离线 */
using MsgConnectorStatus =
  cyberdog_protocol::msg::ConnectorStatus;                 /*!< 连接状态 */
using MsgMotionServoResponse =
  cyberdog_protocol::msg::MotionServoResponse;             /*!< 伺服指令 */
using MsgMotionSequenceGait =
  cyberdog_protocol::msg::MotionSequenceGait;              /*!< 运动序列步态 */
using MsgMotionSequencePace =
  cyberdog_protocol::msg::MotionSequencePace;              /*!< 运动序列步伐 */
using MsgTouchStatus =
  cyberdog_protocol::msg::TouchStatus;                     /*!< 触摸板 */
using MsgBmsStatus = cyberdog_protocol::msg::BmsStatus;    /*!< 电池系统 */
using MsgPersonnel =
  cyberdog_protocol::msg::UserInformation;                 /*!< 人员信息 */
using MsgFaceRes =
  cyberdog_protocol::msg::FaceRecognitionResult;           /*!< 人脸识别反馈 */
using MsgGesture =
  cyberdog_protocol::msg::GestureActionResult;             /*!< 手势信息 */
using MsgSport =
  cyberdog_protocol::msg::SportCountsResult;               /*!< 骨骼点 消息 */
using MsgPreset = cyberdog_protocol::msg::Label;           /*!< 预置点 消息 */
using MsgTrainingWords =
  cyberdog_protocol::msg::TrainPlan;                       /*!< 训练词 */
using MsgAlgoStatus =
  cyberdog_protocol::msg::AlgoTaskStatus;                  /*!< 算法状态 */
using MsgVisualProgrammingOperate =
  cyberdog_protocol::msg::VisualProgrammingOperate;        /*!< 任务操作消息 */

using SrvVisualProgrammingOperate =
  cyberdog_protocol::srv::VisualProgrammingOperate;        /*!< 任务操作服务 */
using SrvTrainingWords =
  cyberdog_protocol::srv::TrainPlanAll;                    /*!< 训练词服务 */
using SrvPersonnel =
  cyberdog_protocol::srv::AllUserSearch;                   /*!< 人员服务 */
using SrvFaceRec = cyberdog_protocol::srv::FaceRec;        /*!< 人脸识别服务 */
using SrvGesture =
  cyberdog_protocol::srv::GestureActionControl;            /*!< 手势服务 */
using SrvSport = cyberdog_protocol::srv::SportManager;     /*!< 骨骼点服务 */
using SrvMotionSequenceShow =
  cyberdog_protocol::srv::MotionSequenceShow;              /*!< 序列动作 */
using SrvMotionResultCmd =
  cyberdog_protocol::srv::MotionResultCmd;                 /*!< 结果指令 */
using SrvLedExecute = cyberdog_protocol::srv::LedExecute;  /*!< led */
using SrvAudioTextPlay =
  cyberdog_protocol::srv::AudioTextPlay;                   /*!< audio 播放 */
using SrvAudioGetVolume =
  cyberdog_protocol::srv::AudioVolumeGet;                  /*!< audio 音量获取 */
using SrvAudioSetVolume =
  cyberdog_protocol::srv::AudioVolumeSet;                  /*!< audio 音量设置 */
using SrvGetPreset = cyberdog_protocol::srv::GetMapLabel;  /*!< audio 获取预置点 */
using SrvCancelNavigation =
  cyberdog_protocol::srv::StopAlgoTask;                    /*!< 取消导航 */
using SrvSetBool = std_srvs::srv::SetBool;        /*!< bool类型 */
using SrvElecSkin = cyberdog_protocol::srv::ElecSkin;      /*!< skin 设置皮肤 */

using ActNavigation =
  cyberdog_protocol::action::Navigation;                   /*!< 导航动作 */
...
enum StateCode
{
  invalid                               = -1,     /*!< 无效 */
  success                               = 0,      /*!< 成功 */
  error_base                            = 7900,   /*!< 错误基础码 */
  fail                                  = 7921,   /*!< [ 全局码 ]失败 */
  uninitialized                         = 7922,   /*!< [ 全局码 ]未初始化 */
  fsm_does_not_allow                    = 7923,   /*!< [ 全局码 ]状态机不允许 */
  module_status_error                   = 7924,   /*!< [ 全局码 ]模块状态错误 */
  network_error                         = 7925,   /*!< [ 全局码 ]网络错误 */
  no_operation_authority                = 7926,   /*!< [ 全局码 ]无操作权限 */
  timeout                               = 7927,   /*!< [ 全局码 ]超时 */
  command_does_not_support              = 7928,   /*!< [ 全局码 ]指令不支持 */
  self_test_failed                      = 7929,   /*!< [ 全局码 ]自检失败 */
  parameter_is_invalid                  = 7930,   /*!< [ 全局码 ]参数不合法 */
  status_is_busy                        = 7931,   /*!< [ 全局码 ]状态忙碌 */
  hardware_error                        = 7932,   /*!< [ 全局码 ]硬件错误 */
  command_waiting_execute               = 7941,   /*!< [ 模块码 ]命令等待执行 */
  spin_future_interrupted               = 7942,   /*!< [  ROS  ]请求循环服务中断 */
  spin_future_timeout                   = 7943,   /*!< [  ROS  ]请求循环服务超时/延迟 */
  no_data_update                        = 7944,   /*!< [ Topic ]无数据更新 */
  service_client_interrupted            = 7945,   /*!< [Service]客户端在请求服务出现时被打断 */
  service_appear_timeout                = 7946,   /*!< [Service]等待服务出现（启动）超时 */
  service_request_interrupted           = 7947,   /*!< [Service]请求服务中断 */
  service_request_rejected              = 7948,   /*!< [Service]请求服务被拒绝 */
  service_request_timeout               = 7949,   /*!< [Service]请求服务超时/延迟 */
  action_request_timeout                = 7950,   /*!< [Action ]请求动作超时/延迟 */
  action_request_rejected               = 7951,   /*!< [Action ]请求动作被拒绝 */
  action_result_timeout                 = 7952,   /*!< [Action ]等待动作结果超时/延迟 */

  motion_error                          = 7961,  /*!< [不影响运行]运控异常 */
};
