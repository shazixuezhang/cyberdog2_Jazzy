...
include <cyberdog_protocol/action/speech.hpp>
...
class CtrlAudio final : public rclcpp::Node
{
  ...
  using AudioSrv = cyberdog_protocol::srv::AudioTextPlay;        /*!< [topic 类型]语音服务 */
  using AudioAct = cyberdog_protocol::action::Speech;            /*!< [action 类型]语音动作 */
