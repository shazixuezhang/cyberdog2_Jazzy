...
include <cyberdog_protocol/msg/wifi_info.hpp>
include <cyberdog_protocol/msg/notify_to_app.hpp>
include <cyberdog_protocol/msg/bluetooth_status.hpp>
...
include <cyberdog_protocol/srv/connector.hpp>
include <cyberdog_protocol/srv/connector_status.hpp>
include <cyberdog_protocol/srv/led_execute.hpp>
include <cyberdog_protocol/srv/wifi_connect.hpp>
...
class Connector final : public rclcpp::Node
{
  ...
  using AudioMsg = cyberdog_protocol::msg::AudioPlay;                  /*!< [topic 类型]语音消息 */

  using ConnectorStatusMsg = cyberdog_protocol::msg::ConnectorStatus;  /*!< [topic 类型]连接状态消息 */
  using TouchMsg = cyberdog_protocol::msg::TouchStatus;                /*!< [topic 类型]触摸板状态消息 */
  using WiFiMsg = cyberdog_protocol::msg::WifiStatus;                  /*!< [topic 类型]WiFi 消息 */
  using ConnectorSrv = cyberdog_protocol::srv::Connector;              /*!< [service 类型]连接 服务 */
  using WiFiSrv = cyberdog_protocol::srv::WifiConnect;                 /*!< [service 类型]WiFi 服务 */
  using LedSrv = cyberdog_protocol::srv::LedExecute;                   /*!< [service 类型]LED 驱动服务 */
  using CameraSrv = cyberdog_protocol::srv::CameraService;             /*!< [service 类型]相机 驱动服务 */

  using NotifyToAppMsg = cyberdog_protocol::msg::NotifyToApp;  /*!< [topic 类型]通知APP连接状态消息 */
  using WIFIINFOMSG = cyberdog_protocol::msg::WifiInfo;
  using BLUETOOTHSTATUSMSG = cyberdog_protocol::msg::BluetoothStatus;
  using ConnectorStatus = std_msgs::msg::String;
  using BLEDfuProgressMsg = cyberdog_protocol::msg::BLEDFUProgress;
...
private:
  ...
  void APPSendWiFiCallback(const cyberdog_protocol::msg::WifiInfo::SharedPtr msg);
  void AppConnectState(const std_msgs::msg::Bool msg);
  void BtStatusCallback(const cyberdog_protocol::msg::BluetoothStatus::SharedPtr msg);
