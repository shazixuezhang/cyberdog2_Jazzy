...
#include "cyberdog_protocol/srv/bms_cmd.hpp"
...
private:
  ...
  rclcpp::Subscription<cyberdog_protocol::msg::BluetoothStatus>::SharedPtr bluetooth_status_sub_ {nullptr};
  rclcpp::Client<cyberdog_protocol::srv::BmsCmd>::SharedPtr control_advertise_client_ {nullptr};
