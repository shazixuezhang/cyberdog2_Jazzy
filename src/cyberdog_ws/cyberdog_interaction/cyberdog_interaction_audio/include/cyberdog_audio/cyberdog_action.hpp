...
public:
  ...
  : Node("audio_action")
  {
    ...
    motion_status_sub_ =
      this->create_subscription<cyberdog_protocol::msg::MotionStatus>(
      "motion_status", 10,
    ...
    audio_play_pub =
      this->create_publisher<cyberdog_protocol::msg::AudioPlayExtend>(
      "speech_play_extend", rclcpp::SystemDefaultsQoS());
    motion_ressult_client_ =
      this->create_client<cyberdog_protocol::srv::MotionResultCmd>("motion_result_cmd");
    bms_status_sub_ =
      this->create_subscription<cyberdog_protocol::msg::BmsStatus>(
      "bms_status", 10,
...
private:
  void GetCurrentMotionID(const cyberdog_protocol::msg::MotionStatus::SharedPtr msg)
  {
...
private:
  rclcpp::Publisher<cyberdog_protocol::msg::AudioPlayExtend>::SharedPtr audio_play_pub;
  rclcpp::Publisher<cyberdog_protocol::msg::MotionServoCmd>::SharedPtr motion_servo_request_pub_;
  rclcpp::Subscription<cyberdog_protocol::msg::MotionStatus>::SharedPtr motion_status_sub_;
  int motion_id_;
  rclcpp::Client<cyberdog_protocol::srv::MotionResultCmd>::SharedPtr motion_ressult_client_;
