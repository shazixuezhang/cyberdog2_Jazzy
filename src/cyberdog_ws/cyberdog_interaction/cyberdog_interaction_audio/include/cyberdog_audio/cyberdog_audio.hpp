...
#include "cyberdog_protocol/msg/wifi_status.hpp"
#include "cyberdog_protocol/msg/audio_play.hpp"
#include "cyberdog_protocol/msg/audio_play_extend.hpp"
#include "cyberdog_protocol/msg/audio_voiceprint_result.hpp"
#include "cyberdog_protocol/msg/bms_status.hpp"
#include "cyberdog_protocol/msg/auth_token.hpp"
#include "cyberdog_protocol/msg/train_plan.hpp"
...
#include "cyberdog_protocol/srv/audio_volume_get.hpp"
#include "cyberdog_protocol/srv/audio_text_play.hpp"
#include "cyberdog_protocol/srv/audio_voiceprint_entry.hpp"
#include "cyberdog_protocol/srv/trigger.hpp"
#include "cyberdog_protocol/srv/sdcard_play_id_query.hpp"
#include "cyberdog_protocol/srv/train_plan.hpp"
...
private:
  ...
  int32_t OnLowPower();
  int32_t OnOta();
  void SpeechCallback(const cyberdog_protocol::msg::AudioPlay::SharedPtr msg);
  void SpeechExtendCallback(const cyberdog_protocol::msg::AudioPlayExtend::SharedPtr msg);
  void WifiCallback(const cyberdog_protocol::msg::WifiStatus::SharedPtr msg);
  ...
  void BmsStatus(const cyberdog_protocol::msg::BmsStatus::SharedPtr msg);
  void ContinueDialog(const std_msgs::msg::Bool::SharedPtr msg);
  void NlpControl(const std_msgs::msg::String::SharedPtr msg);
  void SetAudioState(
    const cyberdog_protocol::srv::AudioExecute::Request::SharedPtr request,
    cyberdog_protocol::srv::AudioExecute::Response::SharedPtr respose);
  void GetAudioState(
    const cyberdog_protocol::srv::AudioExecute::Request::SharedPtr request,
    cyberdog_protocol::srv::AudioExecute::Response::SharedPtr respose);
  void GetAuthDid(
    const cyberdog_protocol::srv::AudioAuthId::Request::SharedPtr,
    cyberdog_protocol::srv::AudioAuthId::Response::SharedPtr response);
  void SetAuthToken(
    const cyberdog_protocol::srv::AudioAuthToken::Request::SharedPtr request,
    cyberdog_protocol::srv::AudioAuthToken::Response::SharedPtr response);
  void VoiceprintCallback(
    const cyberdog_protocol::srv::AudioVoiceprintTrain::Request::SharedPtr request,
    cyberdog_protocol::srv::AudioVoiceprintTrain::Response::SharedPtr);
  void VoiceprintsSetCallback(
    const cyberdog_protocol::srv::AudioVoiceprintsSet::Request::SharedPtr request,
    cyberdog_protocol::srv::AudioVoiceprintsSet::Response::SharedPtr response);
  void SetNickNameSwitchCallback(
    const std_srvs::srv::SetBool::Request::SharedPtr request,
    std_srvs::srv::SetBool::Response::SharedPtr response);
  void SetNickNameCallback(
    const cyberdog_protocol::srv::AudioNickName::Request::SharedPtr request,
    cyberdog_protocol::srv::AudioNickName::Response::SharedPtr response);
  void AudioVolumeSet(
    const cyberdog_protocol::srv::AudioVolumeSet::Request::SharedPtr request,
    cyberdog_protocol::srv::AudioVolumeSet::Response::SharedPtr response);
  void AudioVolumeGet(
    const cyberdog_protocol::srv::AudioVolumeGet::Request::SharedPtr request,
    cyberdog_protocol::srv::AudioVolumeGet::Response::SharedPtr response);
  void AudioTextPlay(
    const cyberdog_protocol::srv::AudioTextPlay::Request::SharedPtr request,
    cyberdog_protocol::srv::AudioTextPlay::Response::SharedPtr response);
  void SdcardPlayidQuery(
    const cyberdog_protocol::srv::SdcardPlayIdQuery::Request::SharedPtr request,
    cyberdog_protocol::srv::SdcardPlayIdQuery::Response::SharedPtr response);
  void AudiActiveState(
    const cyberdog_protocol::srv::Trigger::Request::SharedPtr request,
    cyberdog_protocol::srv::Trigger::Response::SharedPtr response);
  ...
  void AudioVoiceEntry(
    const cyberdog_protocol::srv::AudioVoiceprintEntry::Request::SharedPtr request,
    cyberdog_protocol::srv::AudioVoiceprintEntry::Response::SharedPtr response);
...
private:
  ...
  rclcpp::Subscription<cyberdog_protocol::msg::AudioPlay>::SharedPtr speech_sub_;
  rclcpp::Subscription<cyberdog_protocol::msg::AudioPlayExtend>::SharedPtr speech_extend_sub_;
  rclcpp::Subscription<cyberdog_protocol::msg::WifiStatus>::SharedPtr wifi_sub_;
  ...
  rclcpp::Service<cyberdog_protocol::srv::AudioExecute>::SharedPtr audio_set_status_srv_;
  rclcpp::Service<cyberdog_protocol::srv::AudioExecute>::SharedPtr audio_get_status_srv_;
  rclcpp::Service<cyberdog_protocol::srv::AudioAuthId>::SharedPtr audio_auth_did_srv_;
  rclcpp::Service<cyberdog_protocol::srv::AudioAuthToken>::SharedPtr audio_auth_token_srv_;
  rclcpp::Service<cyberdog_protocol::srv::AudioVoiceprintTrain>::SharedPtr audio_voiceprint_train_srv_;
  rclcpp::Service<cyberdog_protocol::srv::AudioVoiceprintsSet>::SharedPtr audio_voiceprints_data_set_srv_;
  rclcpp::Service<std_srvs::srv::SetBool>::SharedPtr audio_nick_name_switch_srv_;
  rclcpp::Service<cyberdog_protocol::srv::AudioNickName>::SharedPtr audio_nick_name_set_srv_;
  rclcpp::Service<cyberdog_protocol::srv::AudioVolumeSet>::SharedPtr audio_volume_set_srv_;
  rclcpp::Service<cyberdog_protocol::srv::AudioVolumeGet>::SharedPtr audio_volume_get_srv_;
  rclcpp::Service<cyberdog_protocol::srv::AudioTextPlay>::SharedPtr audio_text_play_srv_;
  rclcpp::Service<cyberdog_protocol::srv::Trigger>::SharedPtr audio_active_state_srv_;
  ...
  rclcpp::Service<cyberdog_protocol::srv::SdcardPlayIdQuery>::SharedPtr sdcard_playid_query_srv_;
  rclcpp::Service<cyberdog_protocol::srv::AudioVoiceprintEntry>::SharedPtr audio_voiceprint_entry_srv_;
  rclcpp::Service<cyberdog_protocol::srv::Trigger>::SharedPtr switch_environment_srv_;
  rclcpp::Service<std_srvs::srv::Empty>::SharedPtr stop_play_srv_;
  rclcpp::Publisher<cyberdog_protocol::msg::AudioVoiceprintResult>::SharedPtr audio_voiceprint_result_pub_;
  ...
  rclcpp::Publisher<cyberdog_protocol::msg::AuthToken>::SharedPtr audio_auth_token_pub_;
  rclcpp::Publisher<cyberdog_protocol::msg::TrainPlan>::SharedPtr train_plan_pub_;
  rclcpp::Client<std_srvs::srv::Trigger>::SharedPtr power_client_;
  rclcpp::Client<std_srvs::srv::Trigger>::SharedPtr reboot_client_;
  rclcpp::Client<cyberdog_protocol::srv::TrainPlan>::SharedPtr train_plan_client_;
