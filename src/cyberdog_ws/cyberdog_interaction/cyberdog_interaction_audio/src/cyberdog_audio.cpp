  ...
  is_active_(false), battery_capicity_(100)
{
  ...
  sdcard_playid_query_srv_ =
    this->create_service<cyberdog_protocol::srv::SdcardPlayIdQuery>(
    "sdcard_playid_query",
    std::bind(
      ...
      while (rclcpp::ok()) {
        try {
          ...
          if (!first_notified_net && (check_state != SelfCheckState::SCSUnkown)) {
            ...
            cyberdog_protocol::msg::AudioPlay msg;
            msg.module_name = "self";
            msg.play_id = cyberdog_protocol::msg::AudioPlay::PID_SELF_CHECK_START;
            SpeechCallback(std::make_shared<cyberdog_protocol::msg::AudioPlay>(msg));
          }
...
int32_t cyberdog::interaction::CyberdogAudio::OnSelfCheck()
{
  ...
  // {
  //   std::shared_ptr<cyberdog_protocol::srv::AudioNickName::Request> req =
  //     std::make_shared<cyberdog_protocol::srv::AudioNickName::Request>();
  //   req->nick_name = "铁蛋";
  //   req->wake_name = "铁蛋";
  //   std::shared_ptr<cyberdog_protocol::srv::AudioNickName::Response> res =
  //     std::make_shared<cyberdog_protocol::srv::AudioNickName::Response>();
...
int32_t cyberdog::interaction::CyberdogAudio::OnActive()
{
  if (!is_active_) {
    ...
    audio_set_status_srv_ =
      this->create_service<cyberdog_protocol::srv::AudioExecute>(
      "set_audio_state",
    ...
    audio_auth_did_srv_ =
      this->create_service<cyberdog_protocol::srv::AudioAuthId>(
    ...
    audio_auth_token_pub_ =
      this->create_publisher<cyberdog_protocol::msg::AuthToken>(
      "authenticate_token_enter",
      rclcpp::SystemDefaultsQoS()
      );
    audio_auth_token_srv_ =
      this->create_service<cyberdog_protocol::srv::AudioAuthToken>(
    ...
    audio_voiceprint_train_srv_ =
      this->create_service<cyberdog_protocol::srv::AudioVoiceprintTrain>(
      "voiceprint_train",
      std::bind(
        &CyberdogAudio::VoiceprintCallback, this, std::placeholders::_1,
        std::placeholders::_2));
    audio_voiceprints_data_set_srv_ =
      this->create_service<cyberdog_protocol::srv::AudioVoiceprintsSet>(
    ...
    audio_nick_name_set_srv_ =
      this->create_service<cyberdog_protocol::srv::AudioNickName>(
      "set_nick_name",
      std::bind(
        &CyberdogAudio::SetNickNameCallback, this, std::placeholders::_1,
        std::placeholders::_2));
    audio_volume_set_srv_ =
      this->create_service<cyberdog_protocol::srv::AudioVolumeSet>(
      "audio_volume_set",
      std::bind(
    ...
    audio_volume_get_srv_ =
      this->create_service<cyberdog_protocol::srv::AudioVolumeGet>(
      "audio_volume_get",
      std::bind(
    ...
    audio_text_play_srv_ =
      this->create_service<cyberdog_protocol::srv::AudioTextPlay>(
      "speech_text_play",
      std::bind(
    ...
    audio_active_state_srv_ =
      this->create_service<cyberdog_protocol::srv::Trigger>(
      "audio_active_state",
      std::bind(
    ...
    audio_voiceprint_entry_srv_ =
      this->create_service<cyberdog_protocol::srv::AudioVoiceprintEntry>(
    ...
    audio_voiceprint_result_pub_ =
      this->create_publisher<cyberdog_protocol::msg::AudioVoiceprintResult>(
    ...
    train_plan_pub_ =
      this->create_publisher<cyberdog_protocol::msg::TrainPlan>(
      "train_plan_word",
      rclcpp::SystemDefaultsQoS()
      );
    ...
    train_plan_client_ = this->create_client<cyberdog_protocol::srv::TrainPlan>(
      "query_train_plan",
      rmw_qos_profile_services_default,
      train_callback_group_
    );
  ...
  const std::shared_ptr<SpeechActionServer::GoalHandleSpeech> goal_handle)
{
  ...
  if (goal->is_online) {
    ...
    SpeechCallback(std::make_shared<cyberdog_protocol::msg::AudioPlay>(goal->speech));
  }
}

void cyberdog::interaction::CyberdogAudio::SpeechCallback(
  const cyberdog_protocol::msg::AudioPlay::SharedPtr msg)
{
...
void cyberdog::interaction::CyberdogAudio::SpeechExtendCallback(
  const cyberdog_protocol::msg::AudioPlayExtend::SharedPtr msg)
{
  if (msg->is_online) {
    INFO(
    ...
    SpeechCallback(std::make_shared<cyberdog_protocol::msg::AudioPlay>(msg->speech));
  }
}

void cyberdog::interaction::CyberdogAudio::WifiCallback(
  const cyberdog_protocol::msg::WifiStatus::SharedPtr msg)
{
...
void cyberdog::interaction::CyberdogAudio::GetAudioState(
  const cyberdog_protocol::srv::AudioExecute::Request::SharedPtr,
  cyberdog_protocol::srv::AudioExecute::Response::SharedPtr respose)
{
  GetStatus();
  ...
  cyberdog_protocol::srv::AudioAuthToken::Response::SharedPtr response)
{
  ...
  cyberdog_protocol::msg::AuthToken at_enter;
...
{
  if (request->train_id == cyberdog_protocol::srv::AudioVoiceprintTrain::Request::TID_START) {
    INFO(
  ...
  } else if (request->train_id == cyberdog_protocol::srv::AudioVoiceprintTrain::Request::TID_CANCEL) {
    INFO(
...
void cyberdog::interaction::CyberdogAudio::AudioVolumeGet(
  const cyberdog_protocol::srv::AudioVolumeGet::Request::SharedPtr,
  ...
  cyberdog_protocol::srv::AudioTextPlay::Response::SharedPtr response)
{
  ...
  if (request->is_online) {
    ...
    SpeechCallback(std::make_shared<cyberdog_protocol::msg::AudioPlay>(request->speech));
  }
  uint8_t status = 0;
  {
    // std::unique_lock<std::mutex> lck(play_mtx_);
...
{
  response->success = false;
  if (request->command == cyberdog_protocol::srv::AudioVoiceprintEntry::Request::AVE_DELETE_VOICEPRINT) {
...
void cyberdog::interaction::CyberdogAudio::BmsStatus(
  const cyberdog_protocol::msg::BmsStatus::SharedPtr msg)
{
  ...
  const lcm::ReceiveBuffer * rbuf, const std::string & chan, const audio_lcm::lcm_data * msg)
{
  ...
  if (audio_cyberdog_topic_cmd_map.find(msg->cmd) != audio_cyberdog_topic_cmd_map.end()) {
    ...
    //   auto msg = std::make_shared<cyberdog_protocol::msg::AudioPlay>();
    //   msg->module_name = "self";
    //   msg->play_id = cyberdog_protocol::msg::AudioPlay::PID_AI_ENABLE_SUCCESS;
    //   SpeechCallback(msg);
    // }
    if (true) {
    ...
    if (ae.code == 401) {
      ...
      auto msg = std::make_shared<cyberdog_protocol::msg::AudioPlay>();
      msg->module_name = "self";
      msg->play_id = cyberdog_protocol::msg::AudioPlay::PID_AI_PLEASE_ENABLE;
      SpeechCallback(msg);
    }
    ...
    for (auto & train_cmd : pi.cmds) {
      ...
      std::chrono::seconds timeout(3);
      auto req = std::make_shared<cyberdog_protocol::srv::TrainPlan::Request>();
...
void cyberdog::interaction::CyberdogAudio::VoiceprintResult(const std::string & data)
{
  ...
  cyberdog_protocol::msg::AudioVoiceprintResult avr;
  avr.code = vr.code;
