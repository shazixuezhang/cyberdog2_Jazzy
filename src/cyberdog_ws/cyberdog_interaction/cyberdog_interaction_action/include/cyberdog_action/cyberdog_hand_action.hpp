...
class gesture
{
  using GestureActionSrv = cyberdog_protocol::srv::GestureActionControl;
  using GestureActionMsg = cyberdog_protocol::msg::GestureActionResult;
  using CameraSrv = cyberdog_protocol::srv::CameraService;
  using CameraMsg = sensor_msgs::msg::Image;
  using WifiMsg = cyberdog_protocol::msg::ConnectorStatus;
  using AudioMsg = cyberdog_protocol::msg::AudioPlay;                     /*!< 语音消息:离线 */
