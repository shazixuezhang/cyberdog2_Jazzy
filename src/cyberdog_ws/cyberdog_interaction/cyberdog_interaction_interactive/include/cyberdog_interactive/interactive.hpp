...
{
using SrvMotionResultCmd = cyberdog_protocol::srv::MotionResultCmd;    /*!< 结果指令 */
using MsgMotionStatus = cyberdog_protocol::msg::MotionStatus;          /*!< 运动状态 */
using MsgHeadTofPayload = cyberdog_protocol::msg::HeadTofPayload;      /*!< 头部tof数据 */
using MsgSingleTofPayload = cyberdog_protocol::msg::SingleTofPayload;  /*!< 单个tof数据 */
using MsgAudioPlayExtend = cyberdog_protocol::msg::AudioPlayExtend;    /*!< 语音消息:在线 */
