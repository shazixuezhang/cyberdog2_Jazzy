...
#include "cyberdog_protocol/msg/heartbeats.hpp"
...
public:
  ...
  : HeartBeats(duration, limit), name_(name)
  {
    ...
    pub_ptr_ = node_ptr_->create_publisher<cyberdog_protocol::msg::Heartbeats>("heartbeats_test_topic", 10);
    ...
    sub_ptr_ = node_ptr_->create_subscription<cyberdog_protocol::msg::Heartbeats>(
...
private:
  ...
  void HeartTopicCallback(const cyberdog_protocol::msg::Heartbeats::SharedPtr msg)
  {
...
private:
  std::string name_;
  cyberdog_protocol::msg::Heartbeats beats_msg_;
  rclcpp::Node::SharedPtr node_ptr_ {nullptr};
  rclcpp::Publisher<cyberdog_protocol::msg::Heartbeats>::SharedPtr pub_ptr_ {nullptr};
  rclcpp::Subscription<cyberdog_protocol::msg::Heartbeats>::SharedPtr sub_ptr_ {nullptr};
