...
public:
  ...
  : name_(name)
  {
    ...
    heartbeats_pub_ = node_ptr_->create_publisher<cyberdog_protocol::msg::Heartbeats>(
      "manager_heartbeats",
...
private:
  void HeartKeep()
  {
    cyberdog_protocol::msg::Heartbeats msg;
    // msg.name = "audio";
    msg.name = name_;
...
private:
  ...
  rclcpp::Publisher<cyberdog_protocol::msg::Heartbeats>::SharedPtr heartbeats_pub_;
};  // class HeartBeatsActuator
}  // namespace machine
}  // namespace cyberdog
